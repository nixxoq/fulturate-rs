        ...
        $crate::module! {
            ...
            impl {
                async fn get_settings_ui(
                    ...
                    let settings: $settings = Settings::get_module_settings(owner, self.key()).await?;
                ...
                async fn handle_callback(
                    ...
                    use $crate::bot::modules::{save_and_refresh};
                    ...
                    if parts.len() >= 1 && parts[0] == "toggle_module" {
                        let mut settings: $settings = Settings::get_module_settings(owner, self.key()).await?;
