...
pub(crate) fn confirm_delete_keyboard(original_user_id: u64, locale: &str) -> InlineKeyboardMarkup {
    ...
    let buttons = vec![
        InlineKeyboardButton::callback(t!("common.yes", locale = locale), yes_callback),
        InlineKeyboardButton::callback(t!("common.no", locale = locale), no_callback),
    ];
